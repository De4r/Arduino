 ...
 */
// Data correction :
float tempCorrection = 1.325; // For 3rd module 1.03, for 1st module 1.715, for 2nd module 1.325

// Adresses of all nodes: 00 - master node, 01-04 - 2st lvl child nodes
const uint16_t nof = 3; // number of nodes
const uint16_t node_address_set[nof] = {00, 01, 02};
uint8_t NODE_ADDRESS = 2; // Selecting actual node adress
