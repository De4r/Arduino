...
class serialRead():
    def __init__(self, sensor='BH1750', serial_port='COM4',
                 baud_rate='115200', sen_num=3):
        self.sensor = sensor
        ...
        for i in range(1, self.sen_num+1):
    ...
    def start(self):
        ...
        ser.open()
        dataBuffer = np.zeros(self.sen_num+1)
